...
<template>
  <div class="col">
    <div class="card product-card shadow-lg rounded-4">
      ...
      <div class="card-body">
        <div
          class="rating d-flex justify-content-between align-items-center mb-2"
        >
          <img
        ...
        <div
          class="d-flex gap-1 justify-content-between position-relative mt-3"
        >
          <div v-if="addedToCartMsg" class="position-absolute bottom-50">
          ...
          <div v-if="addedToFavsMsg" class="position-absolute bottom-50 end-0">
            <p class="text-success fw-semibold">
              Added <i class="bi bi-heart-fill"></i>
            </p>
          </div>
          <button
            @click="addToFavorites"
            class="btn btn-outline-danger w-25 mt-3 p-1 shadow"
          >
