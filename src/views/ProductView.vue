            ...
            <div class="col-md-8">
              <div class="card-body p-xl-5 p-sm-4">
                ...
                <h5 class="card-text my-4">
                  ...
                  product, the number of people that rated it is
                  <span class="fw-bold text-primary-emphasis"
                    >{{ product.rating.count }}.</span
                  >
                  It is rated
                  <span class="fw-bold text-warning-emphasis"
                    >{{ product.rating.stars }} / 5</span
                  >
                  from the people that purchased it.
                </h5>
                <h3 class="card-text">
                  Price:
                  <span class="fw-bold text-warning-emphasis"
                ...
                <div
                  class="d-flex gap-2 justify-content-between mt-5 position-relative"
                >
                  <div
                    v-if="addedToCartMsg"
                    class="position-absolute bottom-50"
                  >
                    <p class="text-success fw-semibold fs-4">
                  ...
                  >
                    <p
                      class="text-success fw-semibold fs-4 ms-5 ps-3 d-flex gap-1"
                    >
